...
function HomePage() {
    return (
        <div>
            ...
            {/* Footer Section */}
            <footer>
                <p>&copy; {new Date().getFullYear()} NutriWise. All rights reserved.</p>
                <nav>
